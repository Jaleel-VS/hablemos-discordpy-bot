...
| `$resetintro <user_id>` (alias: `$clearintro`) | Clear a user's intro history. Allowed with `manage_messages` **or** the Trail Staff Helper role (`591745589054668817`) and above. |
